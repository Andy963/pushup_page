...
class TrackLoader:
    ...
    def load_tracks_from_db(self, db_file, with_polyine) -> typing.List[Track]:
    ...
    def _filter_and_merge_tracks(self, tracks: typing.List[Track]) -> typing.List[Track]:
        ...
        # filter out tracks with count < min_count
        tracks = [t for t in tracks if t.count >= self._min_count]
