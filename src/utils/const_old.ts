...
//set to `true` if you want to show the 'Elevation Gain' column (not relevant for pushups)
const SHOW_ELEVATION_GAIN = false;
// pushup activity display title
const RUN_TITLES = {
  EN: 'Pushups',
  ZH: '俯卧撑',
};

const ACTIVITY_LABEL_TITLES = {
  EN: 'Pushup Count',
  ZH: '俯卧撑次数',
};
